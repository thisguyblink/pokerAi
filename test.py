...
def test_main():
    ...
    suits = ['Spades', 'Hearts', "", "", "", "", "", "", ""]  
    print("Decision:", aiDecision(nums, suits, emotion=0, weight=0.1))  # Expect raise or all-in

    print("\nTest 2: Pre-flop, weak hand (7-2 offsuit), neutral emotion: Expect call or fold")
    nums = [7, 2, 0, 0, 0, 0, 0, 0, 0]
    suits = ['Spades', 'Diamonds', "", "", "", "", "", "", ""]
    print("Decision:", aiDecision(nums, suits, emotion=0, weight=0.1))  # Expect call or fold
    ...
    print("Decision:", aiDecision(nums, suits, emotion=0.5, weight=0.2))  # Emotion may lead to raise
    ...
    print("Decision:", aiDecision(nums, suits, emotion=-0.7, weight=0.3))  # May fold due to emotion
