...
cardSuites_1 = ['Hearts', 'Clubs', '', '', 'Clubs', 'Hearts', 'Diamonds']  # Suits for AI and community cards
...
cardSuites_2 = ['Spades', 'Diamonds', '', '', 'Spades', 'Diamonds', 'Clubs']  # Suits for AI and community cards
...
cardSuites_3 = ['Hearts', 'Clubs', '', '', 'Clubs', 'Hearts', 'Spades']  # Suits for AI and community cards
...
cardSuites_4 = ['Spades', 'Diamonds', '', '', 'Spades', 'Diamonds', 'Clubs']  # Suits for AI and community cards
...
cardSuites_5 = ['Spades', 'Hearts', '', '', 'Spades', 'Hearts', 'Diamonds']  # Suits for AI and community cards
...
cardSuites_6 = ['Spades', 'Clubs', '', '', 'Spades', 'Clubs', 'Hearts']  # Suits for AI and community cards
